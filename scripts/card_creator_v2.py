...
DEFAULT_REVIEW_INPUT_PATH = Path("data/lemma_review_results.jsonl")
...
SYSTEM_PROMPT = """You are creating concise learner-facing English translations for Modern Greek Anki cards.

Task:
You will be given a word, along with all the ways it had appeared as in a text and an example sentence.
Your task will be to produce the best short English translation to the word. 
Make sure the english transaltion matches the meaning of the target word in the sentence.
...
def main(
    review_input_path: Path = typer.Option(
        ...
        dir_okay=False,
        readable=True,
        help="Path to the reviewed lemma JSON/JSONL file.",
    ),
